...
public class ParseJSON {
    ...
    private String[] placeFormatter(String str){

        if (str.contains("of"))
            return str.split("of ", 2);
        else if (str.contains("the"))
            return str.split("the ", 2);
        else return str.split(" ", 2);
    }
